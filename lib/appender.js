function htmlRunner(){
	...
	var tagMethods = {
		open: function(){
			if(this.hasIframe){
				console.warn("karmaHTML WARN: There was an attempt of opening the html file of '" 
						     + this.tag + "' tag that is already opened. This attempt was ignored.");
				return;
				} else {
					this.hasIframe = true;
					}
		...
		close: function(){
			if(this.hasIframe){
				...
				console.warn("karmaHTML WARN: There was an attempt of closing the html file of '"
						     + this.tag + "' tag that is already closed. This attempt was ignored.");
			}
		},
		reload: function(global){
			if(this.hasIframe){
				...
				console.warn("karmaHTML WARN: There was an attempt of reloading the html file of '" 
						     + this.tag + "' tag that is not opened. This file was opened instead.");
				this.open();
			}
		}
	};	
